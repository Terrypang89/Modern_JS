...
//ut can be easily polyfilled.

//We’ll use window here, assuming that our environment is a browser.
//If your script may run in other environments, it’s better to use globalThis instead.
...
//Modern scripts use JavaScript modules where such thing doesn’t happen.
...
//The code design where a function gets “input” variables and produces certain “outcome” is clearer,
...
//If there’s none (say, we’re in an old browser), we can create “polyfills”:
//add functions that are not supported by the environment, but exist in the modern standard.
