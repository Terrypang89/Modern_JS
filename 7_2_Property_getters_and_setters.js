...
//Another is accessor properties.
...
//Of course, we don’t want to copy-paste existing information,
...
for(let key in user3) console.log(key); // name, surname
...
//Getters/setters can be used as wrappers over “real” property values to
//gain more control over operations with them.
...
//One of the great uses of accessors is that they allow to take control over
//a “regular” data property at any moment by replacing it with a getter and
...
let john1 = new User6("John", new Date(1992, 6, 1));

//Now what to do with the old code that still uses age property?

//We can try to find all such places and fix them, but that takes time and can be hard to do
//if that code is used by many other people.
//And besides, age is a nice thing to have in user, right?

//Let’s keep it and Adding a getter for age solves the problem:
function User7(name, birthday) {
  ...
  Object.defineProperty(this, "age", {
    get() {
      ...
      console.log("this.birthday.getFullYear()= " + this.birthday.getFullYear());
    }
  });
}

let john2 = new User7("John", new Date(1992, 6, 1));

console.log( john2.birthday ); // birthday is available 1992-06-30T16:00:00.000Z
console.log( john2.age );      // ...as well as the age //28
